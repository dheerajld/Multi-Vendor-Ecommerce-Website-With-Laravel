                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ $user->photo ? asset('uploaded/admin/'.$user->photo) : asset('uploaded/no_image.jpg') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6 m-auto text-secondary">
                                        <img id="showPhoto"
                                            src="{{ $user->photo ? asset('uploaded/admin/'.$user->photo) : asset('uploaded/no_image.jpg') }}"
                                            alt="Admin Avatar" width="200">
                                    </div>
                                </div>
                                <div class="row">
