    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Vendor List</div>
            </a>
            <ul>
                <li> <a href="{{ route('admin.inactive_vendor') }}"><i class="bx bx-right-arrow-alt"></i>Inactive Vendor
                        List</a>
                </li>
                <li> <a href="{{ route('admin.active_vendor') }}"><i class="bx bx-right-arrow-alt"></i>Active Vendor
                        List</a>
                </li>
