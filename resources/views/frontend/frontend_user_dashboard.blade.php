                                ...
                                <li class="nav-item">
                                    <form id="logoutForm" action="{{ route('logout') }}" method="post">
                                        ...
                                        <a href="javascript:void(0);"
                                            onclick="document.getElementById('logoutForm').submit()" class="nav-link"><i
                            ...
                            <div class="tab-pane fade" id="account-detail" role="tabpanel"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" name="enq" action="{{ route('user.profile.store') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div>
                                                    <img class="rounded-circle avatar outline-1 my-2" id="showPhoto"
                                                        src="{{ $user->photo ? asset('uploaded/user/'.$user->photo) : asset('uploaded/no_image.jpg') }}"
                                                        alt="User Avatar">
                                                </div>
