                        ...
                        <div class="vendor-img">
                            <a href="{{ route('vendor_details',$vendor->id) }}">
                                <img class="default-img"
                                    src="{{ file_exists(public_path('uploaded/vendor/'.$vendor->photo)) ? asset('uploaded/vendor/'.$vendor->photo) : asset('uploaded/no_image.jpg') }}"
                                    alt="" />
                            </a>
                        </div>
                    ...
                    <div class="vendor-content-wrap">
                        <div class="d-flex justify-content-between align-items-end mb-30">
                            <div>
                                ...
                                <h4 class="mb-5"><a href="{{ route('vendor_details',$vendor->id) }}">{{ $vendor->name
                                        }}</a></h4>
