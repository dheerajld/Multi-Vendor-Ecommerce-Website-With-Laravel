                        ...
                        <div class="detail-gallery">
                            ...
                            <div class="product-image-slider">
                                ...
                                <figure class="border-radius-10">
                                    <img src="{{ file_exists(public_path('uploaded/product/'.$multi_image->image)) ? asset('uploaded/product/'.$multi_image->image) : asset('uploaded/no_image.jpg') }}"
                                        alt="product image" />
                                </figure>
                                @endforeach
                            </div>
                            ...
                            <div class="attr-detail attr-size mb-30">
                                ...
                                <ul class="list-filter size-filter font-small">
                                    <select class="form-control">
                                        ...
                                        @foreach (unserialize($product->product_sizes) as $product_size)
                                        <option value="">{{ $product_size }}</option>
                                ...
                                <ul class="list-filter size-filter font-small">
                                    <select class="form-control">
                                        ...
                                        @foreach (unserialize($product->product_colors) as $product_color)
                                        <option value="">{{ $product_color }}</option>
                            ...
                            <div class="font-xs">
                                ...
                                <ul class="float-start">
                                    ...
                                    <li class="mb-5">Tags:
                                        ...
                                        @foreach (unserialize($product->product_tags) as $tag )
                ...
                <div class="row mt-60">
                    ...
                    <div class="col-12">
                        <div class="row related-products">
                            ...
                            @foreach ($product->category->products->take(4) as $related_product )
                                ...
                                <div class="product-cart-wrap hover-up">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a
                                                href="{{ route('product_details',['product' => $related_product->id,'slug' => $related_product->product_slug]) }}">
                                                <img class="default-img"
                                                    src="{{ file_exists(public_path('uploaded/product/'.$related_product->thumbnail)) ? asset('uploaded/product/'.$related_product->thumbnail) : asset('uploaded/no_image.jpg')  }}"
                                                    alt="" />
                                                <img class="hover-img"
                                                    src="{{ file_exists(public_path('uploaded/product/'.$related_product->thumbnail)) ? asset('uploaded/product/'.$related_product->thumbnail) : asset('uploaded/no_image.jpg')  }}"
                                                    alt="" />
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            ...
                                            <span class="hot">
                                                ...
                                                {{ "save ". $related_product->discount . " %" }}
                                                @elseif ($related_product->featured)
                                                Featured
                                                @elseif ($related_product->special_offer)
                                                Special Offer
                                                @elseif($related_product->special_deal)
                                                Special Deal
                                                @else
                                                New
                                                @endif
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a
                                                href="{{ route('product_details',['product' => $related_product->id,'slug'=>$related_product->product_slug] )}}">{{
                                                $related_product->category->name }}</a>
                                        </div>
                                        <h2><a href="shop-product-right.html">{{ $related_product->product_name }}</a>
                                        </h2>
                                        ...
                                        <div>
                                            <span class="font-small text-muted">By <a href="vendor-details-1.html">{{
                                                    $related_product->user->name ?? 'Owner' }}</a></span>
                                        </div>
